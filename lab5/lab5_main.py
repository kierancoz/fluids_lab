...
def main():
    ...
    # Pdyn = 1/2 * p * v^2
    p_to_vel = lambda x: sqrt(x * 2 / 1.225)
    ...
    plot_forces("Drag", sting_wind_velocities, plot = False, f1 = f1_drag, f150up = f150up_drag, f150down = f150down_drag)
    plot_forces("Lift", sting_wind_velocities, plot = False, f1 = f1_lift, f150up = f150up_lift, f150down = f150down_lift)
